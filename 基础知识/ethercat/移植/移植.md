...
#### 动态在slots插入module后出现0x001e - Invalid SM IN cfg
- 需要修改同步管理器

### 问题

#### 1
1. sm0 0x1000 0x80 0x26 0x01
2. sm1 0x1080 0x80 0x22 0x01
3. sm2 0x1100 0x0c 0x1164 0x01
4. sm3 0x1400 0x0c 0x2220 0x01

#### 2
1. sm0 0x1000 0x80 0x0026 0x01
2. sm1 0x1080 0x80 0x0022 0x01
3. sm2 0x0000 0x00 0x3000 0x01
4. sm3 0x0000 0x00 0x0000 0x01
